...
module.exports = function (chai, utils) {
    ...
    property("fulfilled", function () {
        ...
        var derivedPromise = getBasePromise(this).then(
            function (value) {
                assertIfNegated(_this,
                                "expected promise not to be fulfilled but it was fulfilled with #{act}",
                                { actual: value });
                return value;
            },
            function (reason) {
                assertIfNotNegated(_this,
        ...
        var derivedPromise = getBasePromise(this).then(
            ...
            function (reason) {
                ...
                if (negate && everyArgIsDefined) {
                    ...
                    if (errorLike) {
                        _this.assert(errorLikeCompatible,
                    ...
                    if (errMsgMatcher) {
                        _this.assert(errMsgMatcherCompatible,
    ...
    var methodNames = propertyNames.filter(function (n) {
        return n !== "assert" && typeof propertyDescs[n].value === "function";
    });
    ...
    var getterNames = propertyNames.filter(function (n) {
        return n !== "_obj" && typeof propertyDescs[n].get === "function";
    });
